...
1. **デザイン原則**: 「テックを抽象で語る」というコンセプト、PC モチーフ、余白を含む4つの判断基準。
2. **ライティングガイド**: フォント選定、文字サイズ・行長・行間、見出しの階層、文章の論理構成。
3. **実装ガイド**: テーマ、トークンの使い方、余白の用途別の目安と判断方法、コンポーネントの作り方、アクセシビリティの確認。
...
| 実装ルール・余白の設計 | `docs/design-system.md` | Markdown を直接読み込み |

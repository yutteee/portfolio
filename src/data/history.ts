export const histories = [
  {
    ...
    description: [
      "微生物の研究がしたくて2021年4月に工学部化学生命工学科に入学しました。アプリ開発団体jackというサークルになんとなくで入ったらweb開発ハマり、エンジニアの道を歩み始めました。",
  ...
  },
  {
    ...
    period: "2024年2月〜現在",
    description: [
      "副業でフェアナビというアクセシビリティオーバーレイの開発をしています。プロダクト全体のアクセシビリティの改善に、デザインから実装まで取り組んでいます。",

export const histories = [
	{
		...
		description: [
			...
			"jackでは仲間と一緒に開発したり、遊んだりととても楽しいです。jackに入ってよかったな〜と日々感じています。"
		],
		image: "/meidai.png"
	},
	{
	...
	},
	{
		...
		description: [
			...
			"インターンを通して、Pull Requestを丁寧に書くこと、問題を1人で抱えずにチームとしての成果を意識することなど、実務での開発をする上で必要な意識を学ぶことができたのがとても大きかったです。",
